...
function Product() {
  ...
  return (
    <div className="product">
      ...
      <div className="right">
        <h1>Long sleeve grafic shirt</h1>
        <span>$199</span>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet saepe
          voluptatem velit voluptate maxime quia corporis libero commodi quo
          vitae. Atque reiciendis voluptatem eligendi porro, a aperiam unde
          corporis beatae odit, recusandae animi. Cumque, dicta. Nemo nostrum
          totam quo ex!
        </p>
